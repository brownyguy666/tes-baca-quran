    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="block md:hidden space-y-3 animate-in">
            {filtered.map((t) => (
              <div
                key={t.id}
                id={`log-card-mobile-${t.id}`}
              ...
              >
                  ...
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs" style={{ color: '#64748b' }}>
                        Kelas {t.murid?.kelas || '—'} · Penguji: {t.guru_penguji || '—'}
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between gap-2 flex-wrap pt-1 border-t border-white/5">
                  ...
                  <div className="flex items-center gap-1.5 text-[11px] font-mono" style={{ color: '#94a3b8' }}>
                    <span className="px-2 py-0.5 rounded bg-slate-800/80 border border-slate-700/50">M: {t.skor_makhraj}</span>
                    <span className="px-2 py-0.5 rounded bg-slate-800/80 border border-slate-700/50">T: {t.skor_tajwid}</span>
                    <span className="px-2 py-0.5 rounded bg-slate-800/80 border border-slate-700/50">K: {t.skor_kelancaran}</span>
                  </div>
                </div>

                <div className="flex items-center justify-between gap-2 pt-1 text-xs" style={{ color: '#475569' }}>
          ...
          <div className="hidden md:block card overflow-hidden animate-in">
